...
{
    [CreateAssetMenu(menuName = "ScriptableObjects/Zeds/Motions/Stage One/Move Right")]
    public class MovingRightStageOne : BaseMotionCondition
    {
        [SerializeField]
        private MoveConfig _config;
        private MovingRightStageOneMotion _movingLeft;
        public override IBaseIntervalCondition<SkeletonHandler> MotionCondition
        {
            get
            {
                _movingLeft = new MovingRightStageOneMotion(ID, FrameIntervals, _config);
                return _movingLeft;
            }
        }
    ...
    [Serializable]
    public class MovingRightStageOneMotion : BaseIntervalCondition<SkeletonHandler>
    {
        ...
        public MovingRightStageOneMotion(int id, int frameIntervals, MoveConfig config) : base(id, frameIntervals)
        {
            _config = config;
        }
