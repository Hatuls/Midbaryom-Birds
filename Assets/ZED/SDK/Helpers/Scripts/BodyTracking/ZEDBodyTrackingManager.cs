...
{
    #region vars
    private static ZEDBodyTrackingManager _instance;

    public static ZEDBodyTrackingManager Instance => _instance;
    /// <summary>
...
#if ZED_URP
                var camera = zedManager.GetLeftCamera();
            UniversalAdditionalCameraData urpCamData = camera.GetComponent<UniversalAdditionalCameraData>();
