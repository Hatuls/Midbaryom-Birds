...
{
    public static ZEDBodyTrackingManager Instance;
    #region vars
...
#if ZED_URP
            UniversalAdditionalCameraData urpCamData = zedManager.GetRightCamera().GetComponent<UniversalAdditionalCameraData>();
